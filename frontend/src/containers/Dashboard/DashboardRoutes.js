...
const routes = [
   ...
   },
   {
      path: 'table_ant',
      component: lazy(() =>
         import('@iso/containers/Tables/AntTables/AntTables')
      ),
   },
   {
   ...
   },
   {
      path: 'op_tooltip',
      component: lazy(() =>
         import('@iso/containers/UIElements/Tooltip/Tooltip')
      ),
   },
   {
      path: 'rating',
   ...
   },
   {
      path: 'op_popover',
      component: lazy(() =>
         import('@iso/containers/UIElements/Popover/Popover')
      ),
   },
   {
      path: 'googleChart',
   ...
   },
   {
      path: 'menu',
      component: lazy(() =>
         import('@iso/containers/Navigation/NavigationMenu')
      ),
   },
   {
      path: 'ReactChart2',
...

   {
      path: 'githubSearch',
      component: lazy(() =>
         import('@iso/containers/GithubSearch/GithubSearch')
      ),
   },
   {
      path: 'blank_page',
   ...
   },
   {
      ...
      component: lazy(() => import('@iso/features/CreateCampaign')),
   },
   {
      path: 'user-profile',
